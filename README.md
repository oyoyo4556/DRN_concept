 ...
 **Gridworldでの検証結果(2026年7月12日午後17時)**
...
<img src="./img/drn_v1.3.2_vsdqn.png" width="500px">

>図3:7並べ環境でのdqnとdrnでの10万戦の結果と課題

２着は取れるがトップを取り切れていない。ちょっとぬるい手を積み重ねてしまっていると考えられる。ラス率が大幅に多いわけではないので、あと少し何かがかみ合えばいいモデルになると思われる。７並べにおいて決定論的な方が安定しやすいのも要因の一つだが、おそらく後悔値の予測を盤面だけでやるのが本質的に難しいというのがあると思われる。イメージとしてはこの盤面の期待値最大は近似予測しやすいが、不完全情報ゲームなためノイズも多く、この手を選んだ時にどのくらい損するかは予測が難しいだろう。
