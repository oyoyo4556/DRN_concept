...
２着は取れるがトップを取り切れていない。ちょっとぬるい手を積み重ねてしまっていると考えられる。ラス率が大幅に多いわけではないので、あと少し何かがかみ合えばいいモデルになると思われる。７並べにおいて決定論的な方が安定しやすいのも要因の一つだが、おそらく後悔値の予測を盤面だけでやるのが本質的に難しいというのがあると思われる。イメージとしてはこの盤面の期待値最大は近似予測しやすいが、この手を選んだ時にどのくらい損するかは不完全情報ゲームなためノイズも多く、予測が難しいだろう。
